...
from typing import Tuple_, Optional, Callable, Dict, Any
import math
import time
...
class NHGETrainer:
    ...
    def __init__(
        ...
        decay_params = [p for n, p in model.named_parameters()
                        if p.requires_grad and not any(
                            nd in n for nd in ["bias", "norm", "embed"])]
    ...
    def _forward(self, batch) -> Tuple_:
    ...
    def train(self, epochs: int = 10):
        ...
        for epoch in range(1, epochs + 1):
            ...
            # Save best model
            if self.save_path and val and val["loss"] < best_val_loss:
